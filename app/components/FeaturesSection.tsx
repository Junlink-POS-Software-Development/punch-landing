    ...
    <section id="features" className="py-24 bg-white relative z-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-8">
          <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-100 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 transition-transform group-hover:scale-110"></div>
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-900">Punch POS Backoffice</h3>
                  <p className="text-blue-600 font-medium text-sm uppercase tracking-wider mt-1">The Command Center</p>
                </div>
              </div>
          ...
          <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-100 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-orange-100/50 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3 transition-transform group-hover:scale-110"></div>
            <div className="relative z-10">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-slate-900">Punch POS Terminal</h3>
                  <p className="text-orange-600 font-medium text-sm uppercase tracking-wider mt-1">The Smart Checkout</p>
                </div>
              </div>
              <div className="grid sm:grid-cols-2 gap-8">
