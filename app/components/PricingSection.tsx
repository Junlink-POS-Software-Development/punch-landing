...
export function PricingSection() {
  ...
  return (
    <section id="pricing" className="py-24 bg-slate-950/50 relative z-20 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="max-w-lg mx-auto">
          <div className="flex items-center justify-center gap-4 mb-8">
            ...
            <span className={`text-sm font-bold flex items-center gap-2 transition-colors ${isAnnual ? 'text-white' : 'text-slate-500'}`}>
              Annually 
              <span className="text-[10px] font-extrabold bg-emerald-500/10 text-emerald-400 px-2 py-0.5 rounded-full border border-emerald-500/20">SAVE 16%</span>
            </span>
          </div>

          <div className="bg-slate-900/40 backdrop-blur-md rounded-3xl shadow-2xl shadow-black/50 border border-slate-800 p-8 md:p-10 relative overflow-hidden transform transition-all hover:-translate-y-1">
            ...
            <p className="text-slate-400 text-sm mb-6">Everything you need to run your business smoothly.</p>
            ...
            <button className="w-full bg-white text-slate-900 py-4 rounded-xl font-bold text-lg hover:bg-slate-200 transition-colors mb-8 shadow-lg shadow-white/10">
              Start Free Trial Now
            </button>

            <div className="space-y-4">
              <p className="text-sm font-bold text-white uppercase tracking-wider mb-4">What&apos;s included:</p>
              {[
            ...
            <div className="mt-8 pt-6 border-t border-slate-800 flex items-start gap-3 text-sm text-slate-500">
              <Cloud className="w-5 h-5 text-slate-600 shrink-0 mt-0.5" />
              <p>
                Base plan includes 1GB of secure database storage. <br/>
                <span className="font-semibold text-slate-300">+₱30/month</span> for every additional 1GB exceeded.
              </p>
            </div>
          </div>
        </div>
